...
function createProductJson(
        title: string,
        createdAt: Date,// se indica que es de tipo Date en alusión al objeto Date propio de JavaScript
        stock: number,//Si queremos que un argumento sea opcional de enviar, podemos usar el modificador ? junto al nombre del argumento:
        size: Sizes
    ){
       return {
            title,
