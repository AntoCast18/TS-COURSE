(()=>{
    let myDinamicVar: any;//"eny" como que cualquier cosa puede ir ahi
    myDinamicVar = null;
    myDinamicVar = 100;
    myDinamicVar = true;
    myDinamicVar = {};
    ...
    myDinamicVar = 'Hello';
    const rta = (myDinamicVar as string).toLowerCase(); //forzando que se lo trate como string
    console.log(rta);

    myDinamicVar = 123;
    const rta2 = (<number>myDinamicVar).toFixed();//forzando que se lo trate como number
    console.log(rta2);
})();
